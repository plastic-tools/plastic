...
// prettier-ignore
/** Extracts the type from a channel */
export type ChannelType<C extends AnyChannel> = C extends Channel<infer U> ? U : never;
...
export const isChannel = <T = any>(x: any): x is Channel<T> =>
  isAsyncIterable(x);
